...
public class Exercise04_Cards {
    ...
    */
    ...
    public String[] discardFirstCard(String[] hand) {
        String[] discardCard = new String[4];
        discardCard[0] = hand[1];
        discardCard[1] = hand[2];
        discardCard[2] = hand[3];
        discardCard[3] = hand[4];
        return discardCard;
    ...
    public String[] discardTopCard(String[] remainingDeck) {
        ...
        if (remainingDeck.length > 0) {
            newLength = remainingDeck.length - 1;
        }

        String[] newDeck = new String[newLength];
