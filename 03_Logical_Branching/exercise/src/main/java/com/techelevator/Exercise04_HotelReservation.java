...
public class Exercise04_HotelReservation {
    ...
    public double calculateStayTotal(int numOfTotalNights, int numOfWeekendNights) {
        ...
        } else if (numOfWeekendNights == 0 && numOfTotalNights >= 3) {
            return numOfTotalNights * DISCOUNT_RATE;
        } else if (numOfTotalNights != 0 && numOfTotalNights >= 3) {
            return ((numOfTotalNights - numOfWeekendNights) * DISCOUNT_RATE) + (DAILY_RATE * numOfWeekendNights);
        }
        return 0;
    }
