...
public class Exercise03_Shirts {
    ...
    public char[] buildBulkOrder(int numberOfShirts) {
        char[] distributeShirts = new char[numberOfShirts];

        for (int i = 0; i < distributeShirts.length; i++) {

            if (i % 3 == 0)
                distributeShirts[i] = 'S';
            {


            }
            if (i % 3 == 1)
                distributeShirts[i] = 'M';
            {

            }
            if (i % 3 == 2)
                distributeShirts[i] = 'L';
            {

            }
        }
        return distributeShirts;
    }
