...
public class Exercise05_AcceptPackage<cubicDim> {
    ...
    public boolean acceptPackage(int weightPounds, int lengthInches, int widthInches, int heightInches, boolean isSurchargePaid) {
        boolean packageAcceptance = acceptPackage(weightPounds, lengthInches, widthInches, heightInches);
        if (packageAcceptance) {

            if ((widthInches > 66 || heightInches > 66 || lengthInches > 66) && !isSurchargePaid) {
