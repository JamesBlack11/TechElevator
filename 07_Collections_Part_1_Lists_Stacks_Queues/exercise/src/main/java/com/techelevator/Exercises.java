...
public class Exercises {
    ...
    public List<Double> arrayInt2ListDouble(int[] intArray) {
        ...
        for (Integer willItDivide : intArray) {

            arrayInt2ListDouble.add(willItDivide / 2.0);
    ...
    public List<Integer> oddOnly(Integer[] integerArray) {
        ...
        for (Integer mostDope : integerArray) {

            if (mostDope % 2 != 0) {
                oddOnly.add(mostDope);
            }
    ...
    public boolean foundIntTwice(List<Integer> integerList, int intToFind) {
        ...
        for (Integer findIntTwice : integerList) {
            if (intToFind == findIntTwice) {
                value = value + 1;
            }
        }
    ...
    ** INTERVIEW QUESTION **
    ...
    public List<String> fizzBuzzList(Integer[] integerArray) {
        ...
        for (Integer mostDope : integerArray) {
            ...
            if (mostDope % 3 == 0 && mostDope % 5 == 0) {
                fizzBuzzList.add("FizzBuzz");
            } else if (mostDope % 3 == 0) {
                fizzBuzzList.add("Fizz");
            } else if (mostDope % 5 == 0) {
                fizzBuzzList.add("Buzz");
            } else {
                fizzBuzzList.add(mostDope.toString());
            }
