...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay) {
        if (currentDay == 'M'|| currentDay == 'W'|| currentDay =='F')
             {
                return isStoreOpen(currentHour);
            } else {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        if (isSummer == true) {
            return (currentHour >= 8 && currentHour < 20 && currentDay == 'W') || (currentHour >= 9 && currentHour < 15 && currentDay == 'S') || (currentHour >= 8 && currentHour < 17 && currentDay == 'M'|| currentHour >= 8 && currentHour < 17 && currentDay == 'F');
        } else {
